...
class DocumentDetailResponse(BaseModel):
    ...
    preview_url: str = Field(
        description="Presigned inline URL used only for document preview",
    )
    ...
    modified_by_name: str | None = Field(default=None)
    ...
    submitted_by_name: str | None = Field(default=None)
    submitted_at: datetime | None = Field(
        default=None,
        description="Timestamp when the document was submitted (UTC)",
    )
    ...
    approved_by_name: str | None = Field(default=None)
    ...
    rejected_by_name: str | None = Field(default=None)
    ...
    average_review_grade: float | None = Field(
        default=None,
        ge=1,
        le=10,
        description="Average user review grade for this document",
    )
    review_count: int = Field(
        default=0,
        ge=0,
        description="Number of reviews submitted for this document",
    )
...
class DocumentListItem(BaseModel):
    ...
    average_review_grade: float | None = Field(default=None, ge=1, le=10)
