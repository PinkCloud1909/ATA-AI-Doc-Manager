...
export default function ReportsPage() {
  ...
  const { data: approval } = useQuery({
    queryKey: ["reports", "approval-rate"],
    queryFn: reportsApi.getApprovalRate,
  });
  const { data: grades } = useQuery({
    queryKey: ["reports", "avg-grade"],
    queryFn: reportsApi.getAvgGrade,
  });
  const { data: activity } = useQuery({
    queryKey: ["reports", "activity"],
    queryFn: () => reportsApi.getActivity(20),
  });
