...
// Check if Firebase config is available (fallback to mock if not)
...
const firebaseConfig = isFirebaseConfigured ? {
  ...
  // Dummy config for local development (will use mock auth)
  apiKey: "AIzaSyDummyKeyForLocalDevelopment",
  authDomain: "localhost:3000",
  projectId: "local-test",
  storageBucket: "local-test.appspot.com",
